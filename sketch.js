...
function preload(){
 bgImg = loadImage("road 2.png")
rhImg = loadAnimation("red head person 2.png","red head person 2.png", "red head person 1.png", "red head person 1.png");
booImg = loadImage("boo.png");
sqImg = loadImage("squirrel.png");
treatImg = loadImage("treatImg.png");
blueCar = loadImage("blue car.png");
whiteCar = loadImage("white car (1).png");
redCar  = loadImage("red car.png");
music = loadSound("funky music.mp3");
go = loadImage("gameover cool (1).png");
rhImg2 = loadAnimation("rh3.png")
plg = loadImage("playagain modern (1).png")
help1 = loadImage("help1.png");
stImg =  loadImage("play button.png");
